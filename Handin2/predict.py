...
def main():
    ...
    learning_rate = 0.001
    batch_size = 20  # usually between 10 and 30
    nb_of_epoches = 20
    reg_rate = 0.0004
    ...
    for k in range(
            cv):  # for k-fold cross validation where we can independently choose how large each test set is and how many trials you average over
